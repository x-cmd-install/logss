...
[![x-cmd/install — logss Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/logss.svg?lang=zh)](https://x-cmd.com/install/logss)
...
合计: **2,726** 行代码（覆盖前 5 种语言、共 **26** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 2,530 | 47 | 301 | 16 |
| Toml | 159 | 9 | 25 | 5 |
| Yaml | 33 | 2 | 0 | 2 |
| Svg | 4 | 0 | 0 | 1 |
| Markdown | 0 | 444 | 151 | 2 |

## 源代码

- **上游仓库**: <https://github.com/todoesverso/logss>
- **许可证**: MIT
...
- **Star**: 297 · **Fork**: 11 · **开放 issue**: 2 · **贡献者**: 2

## 累计统计

- **发布数**: 10 · **已合并 PR**: 65 · **开放 PR**: 3 · **已关闭 issue**: 2 · **开放 issue**: 0 · **提交数**: 176
...
| 360d | 2025-09-28 | 1 | 1 | 3 | 0 | 0 | 1 |
| last720d | 2024-10-03 | 1 | 1 | 3 | 0 | 0 | 1 |
...
logss 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `logss` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/logss.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T05:09:51Z._
